...
void MainObject::HandleInputAction(SDL_Event events, SDL_Renderer* screen) 
{
  ...
  if( events.type == SDL_KEYDOWN )//SDL_KEYDOWN
  {
    //Set the velocity
  ...
  //If a key was released
   else if( events.type == SDL_KEYUP )//KEYUP
  {
    ////Set the velocity
      switch( events.key.keysym.sym )
      {
...
void MainObject::MovePlayer(Map& g_map)
{
  if (think_time_ == 0)
  {
    x_val_ = 0;
...
//g++ main.cpp BaseObject.cpp BossObject.cpp BulletObject.cpp CommonFunc.cpp ExplosionObject.cpp game_map.cpp Geometric.cpp ImpTimer.cpp MainObject.cpp PlayerPower.cpp TextObject.cpp ThreatsObject.cpp -IC:\Users\Admin\Downloads\SDL2-devel-2.26.3-mingw\SDL2-2.26.3\x86_64-w64-mingw32\include\SDL2 -LC:\Users\Admin\Downloads\SDL2-devel-2.26.3-mingw\SDL2-2.26.3\x86_64-w64-mingw32\lib -w "-Wl,-subsystem,windows" -lmingw32 -lSDL2main -lSDL2 -o main -IC:\Users\Admin\Downloads\SDL2_image-devel-2.6.3-mingw\SDL2_image-2.6.3\x86_64-w64-mingw32\include\SDL2  -LC:\Users\Admin\Downloads\SDL2_image-devel-2.6.3-mingw\SDL2_image-2.6.3\x86_64-w64-mingw32\lib -w "-Wl,-subsystem,windows" -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -o main -IC:\Users\Admin\Downloads\SDL2_mixer-devel-2.6.3-mingw\SDL2_mixer-2.6.3\x86_64-w64-mingw32\include\SDL2 -LC:\Users\Admin\Downloads\SDL2_mixer-devel-2.6.3-mingw\SDL2_mixer-2.6.3\x86_64-w64-mingw32\lib -w "-Wl,-subsystem,windows" -lmingw32 -lSDL2main -lSDL2 -lSDL2_mixer -o main -IC:\Users\Admin\Downloads\SDL2_ttf-devel-2.20.2-mingw\SDL2_ttf-2.20.2\x86_64-w64-mingw32\include\SDL2 -LC:\Users\Admin\Downloads\SDL2_ttf-devel-2.20.2-mingw\SDL2_ttf-2.20.2\x86_64-w64-mingw32\lib -w "-Wl,-subsystem,windows" -lmingw32 -lSDL2main -lSDL2 -lSDL2_ttf -o main       
